...
from breakout_screener.repositories.base import (
    NotFoundError,
    PaginationParams,
    SortParams,
)
...
class TestStockRepository:
    ...
    @pytest.mark.asyncio
    async def test_get_by_symbol_or_raise_not_found(
    ...
    @pytest.mark.asyncio
    async def test_bulk_create_stocks(
        self, stock_repository: StockRepository, sample_stock_data
    ):
    ...
    async def test_get_by_unique_field(
        ...
        stock = await stock_repository.get_by_unique_field(
