...
from sqlalchemy import Column, String, Boolean, BigInteger, Date, Index, CheckConstraint
...
class Stock(BaseModel):
    ...
    @classmethod
    def from_v1_data(cls, script_name: str, group_name: str, company_name: Optional[str] = None) -> 'Stock':
        """
